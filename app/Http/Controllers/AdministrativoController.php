    ...
    public function update(Request $request, $id)
{
    ...
    return redirect()->route('admin.administrativos.index')
        ->with('mensaje', 'Personal administrativo actualizado correctamente')
        ->with('icono', 'success');
}
    ...
    {
        $administrativo = Administrativo::findOrFail($id); // Usar findOrFail para lanzar una excepción si no se encuentra
        $usuarioAsociado = $administrativo->usuario; // Obtener el usuario asociado antes de eliminar el administrativo
